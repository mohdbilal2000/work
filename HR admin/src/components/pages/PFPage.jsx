...
import './PFPage.css'
import { pfAPI } from '../../services/api'
...
function PFPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      const response = await pfAPI.create({
        ...formData,
  ...
  const workflowSteps = [
    {
      ...
      description: 'Register employees for PF compliance'
    },
    {
      number: 2,
      title: 'UAN Generation',
      description: 'Generate Universal Account Number (UAN) for employees'
    },
    {
      number: 3,
    ...
    },
    {
      ...
      description: 'Process monthly PF payments to EPFO'
    },
    {
      number: 5,
      title: 'Filing & Returns',
      description: 'File monthly and annual PF returns with EPFO'
    },
    {
      number: 6,
      title: 'Compliance Audit',
      description: 'Conduct regular PF compliance audits'
    }
  ]
  ...
  return (
    <div className="pf-page">
      ...
      <div className="workflow-section">
        <h2 className="workflow-title">PF Compliance Workflow Steps</h2>
      ...
      {loading ? (
        ...
        <div className="status-message">
          No PF records found. Add your first PF record!
        </div>
      )}
